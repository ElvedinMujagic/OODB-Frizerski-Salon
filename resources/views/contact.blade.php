...
<section class="pt-24 md:pt-32 pb-24">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <p class="text-center text-gray-600 max-w-2xl mx-auto mb-16">
            Navratite, nazovite ili pošaljite poruku. Voljeli bismo čuti vaše mišljenje.
        </p>
        ...
        <div class="grid md:grid-cols-3 gap-8 max-w-4xl mx-auto mb-16">
            <div class="p-6 text-center bg-gray-50 rounded-xl">
                ...
                <h2 class="font-semibold text-gray-900 mb-2">Adresa</h2>
                <p class="text-gray-600">Dr. Irfan Ljubijankić<br>Bihać, 77000</p>
            </div>
            <div class="p-6 text-center bg-gray-50 rounded-xl">
                <div class="w-12 h-12 rounded-full bg-blue-100 flex items-center justify-center mx-auto mb-4">
                    <svg class="w-6 h-6 text-blue-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <h2 class="font-semibold text-gray-900 mb-2">Telefon</h2>
            ...
            <div class="p-6 text-center bg-gray-50 rounded-xl">
                ...
                <h2 class="font-semibold text-gray-900 mb-2">Radno vrijeme</h2>
                <p class="text-gray-600">Uto-Sub 9:00–17:00<br>Ned–Pon Zatvoreno</p>
            </div>
        </div>
    </div>
</section>
