...
<header id="navbar" class="fixed top-0 left-0 w-full z-50 bg-gray-900 shadow-lg">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex justify-between items-center h-16 md:h-20 gap-4">
            <a href="{{ route('home') }}" class="text-2xl font-display font-bold tracking-wide text-white hover:text-pink-200 transition flex-shrink-0">
            ...
            <div class="flex items-center gap-2 lg:hidden flex-shrink-0">
                @if (Route::has('login'))
                    ...
                    @endauth
                @endif
                <label for="mobile-menu" class="cursor-pointer p-2 text-white hover:text-pink-300" aria-label="Toggle menu">
