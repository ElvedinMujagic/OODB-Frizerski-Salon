        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-xl sm:rounded-2xl border border-gray-100 max-w-xl">
                <div class="p-6 lg:p-8">
                    <p class="text-gray-600 mb-6">Create a new user account with the Stylist role. They will be able to log in and manage appointments assigned to them.</p>
