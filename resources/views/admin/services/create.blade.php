                ...
                <div class="p-6 lg:p-8">
                    <form action="{{ route('admin.services.store') }}" method="POST" class="space-y-4">
                        ...
                        <div>
                            ...
                            <input type="text" name="name" id="name" value="{{ old('name') }}" required class="w-full rounded-md border-gray-300 shadow-sm focus:border-pink-500 focus:ring-pink-500" placeholder="npr. Šišanje">
                            @error('name')
                        ...
                        <div>
                            ...
                            <input type="number" name="avg_time" id="avg_time" value="{{ old('avg_time') }}" required min="1" class="w-full rounded-md border-gray-300 shadow-sm focus:border-pink-500 focus:ring-pink-500" placeholder="npr. 45">
                            @error('avg_time')
                                <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                            @enderror
                        </div>
